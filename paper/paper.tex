...
\begin{figure}
  \centering
  \includegraphics[width=4in]{../figures/reference-geometry.png}
...
eigenvalue pattern as well as the 5 and 7.
...
frame
- need constraints of rear frame that force it to span from rear wheel to
person to head tube
